#Sandlike elements Simulation game
#Made by HaydenD100 
#GitHub: https://github.com/HaydenD100
#Use the keyboard buttons from 1-6 for diffrent elements
...
#This Functuon is used too place a circle of the selected elements
...
#this is all the logic for the elements
def Logic(id,x,y):
...
#Drawing function which draws the pixels too the screen
def draw():
...
while running:
    ...
    for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                elif event.key == pygame.K_6: #Acid
                    PlaceId = 7
